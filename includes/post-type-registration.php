...
/**
 * Get the rewrite slug for the FAQ collection taxonomy.
 *
 * @since 1.0.0
 *
 * @return string Collection taxonomy rewrite slug.
 */
...
/**
 * Get the rewrite slug for the FAQ post type archive.
 *
 * @since 1.0.0
 *
 * @return string FAQ post type rewrite slug.
 */
...
/**
 * Get the REST API base slug for the FAQ post type.
 *
 * @since 1.0.0
 *
 * @return string REST base slug.
 */
